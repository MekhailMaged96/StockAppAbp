...
public class InventoryServiceDbContext :
    AbpDbContext<InventoryServiceDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(InventoryServiceConsts.DbTablePrefix + "YourEntities", InventoryServiceConsts.DbSchema);
