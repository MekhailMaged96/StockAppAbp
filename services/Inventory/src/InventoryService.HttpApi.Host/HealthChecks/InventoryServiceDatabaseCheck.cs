...
public class InventoryServiceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InventoryServiceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
