...
public class OrderingServiceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public OrderingServiceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
